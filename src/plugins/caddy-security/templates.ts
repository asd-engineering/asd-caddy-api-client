...
export const LDAP_IDENTITY_STORE_TEMPLATE: SecurityTemplate = {
  ...
  variables: [
    ...
    {
      name: "bindUsername",
      description: "Bind username/DN for LDAP queries",
  ...
  snippet: [
    ...
    '  bindUsername: "${3:cn=admin,dc=example,dc=com}",',
    '  bindPassword: "${4:secret}",',
    '  searchBaseDn: "${5:ou=users,dc=example,dc=com}",',
    '  searchUserFilter: "${6:(uid={username})}",',
    "})",
  ],
};
...
export const OIDC_KEYCLOAK_TEMPLATE: SecurityTemplate = {
  ...
  variables: [
    ...
    {
      name: "metadataUrl",
      description: "OIDC metadata/discovery URL",
  ...
  snippet: [
    ...
    '  clientId: "${1:my-app}",',
    '  clientSecret: "${2:your-client-secret}",',
    '  metadataUrl: "${3:https://keycloak.example.com/realms/myrealm/.well-known/openid-configuration}",',
    '  scopes: ["openid", "email", "profile"],',
    "})",
  ],
};
...
export const OIDC_OKTA_TEMPLATE: SecurityTemplate = {
  ...
  build: () =>
    buildOidcProvider({
      ...
      clientId: "your-client-id",
      clientSecret: "your-client-secret",
      metadataUrl: "https://your-domain.okta.com/.well-known/openid-configuration",
    }),
  snippet: [
    "buildOidcProvider({",
    '  provider: "okta",',
    '  clientId: "${1:your-client-id}",',
    '  clientSecret: "${2:your-client-secret}",',
    '  metadataUrl: "https://${3:your-domain.okta.com}/.well-known/openid-configuration",',
    "})",
  ],
};
...
export const OIDC_AUTH0_TEMPLATE: SecurityTemplate = {
  ...
  snippet: [
    ...
    '  clientId: "${1:your-client-id}",',
    '  clientSecret: "${2:your-client-secret}",',
    '  metadataUrl: "https://${3:your-tenant.auth0.com}/.well-known/openid-configuration",',
    "})",
  ],
};
