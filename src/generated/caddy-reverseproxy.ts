...
export interface PassiveHealthChecks {
   ...
   */
  fail_duration?: any /* caddy.Duration */;
  /**
   ...
   * long to receive.
   */
  unhealthy_latency?: any /* caddy.Duration */;
}
/**
...
export interface HTTPTransport {
   ...
   */
  expect_continue_timeout?: any /* caddy.Duration */;
  /**
...
export interface TLSConfig {
   ...
   */
  handshake_timeout?: any /* caddy.Duration */;
  /**
...
export interface KeepAlive {
   ...
   */
  probe_interval?: any /* caddy.Duration */;
  /**
   ...
   */
  idle_timeout?: any /* caddy.Duration */;
}
...
export interface Handler {
   ...
   */
  flush_interval?: any /* caddy.Duration */;
  /**
   ...
   */
  stream_timeout?: any /* caddy.Duration */;
  /**
   ...
   */
  stream_close_delay?: any /* caddy.Duration */;
  /**
...
export interface LoadBalancing {
   ...
   */
  try_duration?: any /* caddy.Duration */;
  /**
   ...
   */
  try_interval?: any /* caddy.Duration */;
  /**
...
export interface SRVUpstreams {
   ...
   * client. Default: 0s.
   */
  grace_period?: any /* caddy.Duration */;
  /**
