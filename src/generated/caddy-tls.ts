...
export interface ACMEIssuer {
   ...
   */
  acme_timeout?: any /* caddy.Duration */;
  /**
   ...
   */
  certificate_lifetime?: any /* caddy.Duration */;
  /**
...
export interface AutomationConfig {
   ...
   */
  ocsp_interval?: any /* caddy.Duration */;
  /**
   ...
   */
  renew_interval?: any /* caddy.Duration */;
  /**
   ...
   */
  storage_clean_interval?: any /* caddy.Duration */;
}
/**
...
export interface DNSChallengeConfig {
   ...
   */
  ttl?: any /* caddy.Duration */;
  /**
   * How long to wait before starting propagation checks.
   * Default: 0 (no wait).
   */
  propagation_delay?: any /* caddy.Duration */;
  /**
   * Maximum time to wait for temporary DNS record to appear.
   * Set to -1 to disable propagation checks.
   * Default: 2 minutes.
   */
  propagation_timeout?: any /* caddy.Duration */;
  /**
...
export interface ECHPublication {
   ...
   */
  publishers?: any /* caddy.ModuleMap */;
}
/**
 * ECHDNSProvider can service DNS entries for ECH purposes.
 */
export type ECHDNSProvider = 
    any /* libdns.RecordGetter */ &
    any /* libdns.RecordSetter */;
/**
...
export interface SessionTicketService {
   ...
   */
  rotation_interval?: any /* caddy.Duration */;
  /**
...
export interface TLS {
   ...
   */
  certificates?: any /* caddy.ModuleMap */;
  /**
